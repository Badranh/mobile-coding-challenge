...
public class GitColorsUtil {
    ...
    public static GitColor getColorHex(String language){
        if(map == null){
            String jsonString = "{\n" +
                    "    \"1C Enterprise\": {\n" +
                    "        \"color\": \"#814CCC\",\n" +
                    ...
                    "}\n";
            Gson gson = new Gson();
            Type empMapType = new TypeToken<Map<String, GitColor>>() {}.getType();
           map = gson.fromJson(jsonString, empMapType);
           GitColor gitColor = new GitColor("#000000");
           map.put("def",gitColor);
        }
        if(map == null){
            //handle
        }
